...
namespace ClassActivity.Controllers
    ...
    public class MyListController : Controller
        ...
        public ActionResult Create([Bind(Include = "ID,ListCode,Name,Description,ListItemTypeID")] List list)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ListID,ListCode,Name,Description,ListItemTypeID")] List list)
            {
            if (ModelState.IsValid)
                {
